...
window.addEventListener("load", () => {
  Swal.fire({
    title: "Do you want to play music in the background, Kiyot?",
    icon: "warning",
...
const animationTimeline = () => {
  ...
  tl.to(".container", 0.6, {
	...
	.fromTo(".one-image-bg", 1, 
    { opacity: 0, x: 20, visibility: "hidden" }, 
    { opacity: 0.6, x: 0, visibility: "visible" }, 
    "-=0.5" // Mulai sedikit sebelum teks selesai muncul
	)
    .from(".two", 0.9, {
      opacity: 0,
      y: 10,
